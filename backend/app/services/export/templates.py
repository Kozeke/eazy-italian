...
# Header brand mark is an inline SVG in _TPL_UNIT_EXPORT (no external assets).
...
/* Inline LinguAI mark + wordmark (matches app LinguAiLogo). */
.brand-mark {
  display: flex; align-items: center; flex-shrink: 0;
  line-height: 0;
}
.brand-mark svg { display: block; height: 32px; width: auto; }
.brand-mark .brand-word-lingu { fill: var(--text-color); }
.brand-mark .brand-word-ai { fill: var(--brand-primary); }
.unit-title-header {
...
<div class="header">
  <div class="header-left">
    <div class="brand-mark" aria-label="LinguAI">
      <svg width="108" height="32" viewBox="0 0 135 40" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
        <circle cx="20" cy="20" r="17" stroke="#6C6FEF" stroke-width="1.6"/>
        <circle cx="20" cy="20" r="9" stroke="#6C6FEF" stroke-width="1.1" opacity="0.4"/>
        ...
        <text class="brand-word-lingu" x="48" y="26" font-family="system-ui, -apple-system, 'Segoe UI', Arial, sans-serif" font-weight="700" font-size="19" letter-spacing="-0.5">Lingu</text>
        <text class="brand-word-ai" x="106" y="26" font-family="system-ui, -apple-system, 'Segoe UI', Arial, sans-serif" font-weight="700" font-size="19" letter-spacing="-0.5">AI</text>
      </svg>
    </div>
