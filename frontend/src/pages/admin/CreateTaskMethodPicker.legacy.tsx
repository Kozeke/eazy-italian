/**
 * CreateTaskMethodPicker.legacy.tsx
 *
 * ── Purpose ───────────────────────────────────────────────────────────────────
 *   Intercepts every "Create Task" entry-point in the teacher flow.
 ...
 *
 * ── Usage ─────────────────────────────────────────────────────────────────────
 *   Drop it as an overlay from UnitTaskSection (AdminTaskBuilder.legacy.tsx) or from
 *   the "Create task" button in AdminUnitDetailPage.legacy.jsx.
 *
 *   Props:
 ...
 *     onAI        () => void      — caller opens AITaskGenerationWizard
 *
 * ── Styling language ──────────────────────────────────────────────────────────
...
/* ═══════════════════════════════════════════════════════════════════════════
   ...
   ─────────────────────────────────────────────────────────────────────────── */
interface CreateTaskMethodPickerProps {
  open: boolean;
  onClose: () => void;
  ...
  onAI: () => void;       // () => void — caller opens AITaskGenerationWizard
}

export function CreateTaskMethodPicker({
  open,
  onClose,
    ...
    <>
      ...
      >
        <div className="ctmp-sheet">
          ...
          {/* Heading */}
          <div className="ctmp-title">Create Task</div>
          <div className="ctmp-sub">Choose how you want to create your task.</div>
...
export default CreateTaskMethodPicker;
