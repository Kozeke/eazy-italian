/**
 * useAITaskGeneration.legacy.ts
 *
 * Mutation hook for the "Generate with AI" secondary action inside
 * AdminTaskBuilder.legacy.tsx. This is the single integration layer — neither
 ...
 *   → lives in generateTasksAI() inside AITaskGenerationWizard.legacy.tsx (shared, one source)
...
/* ─── Shape used by AdminTaskBuilder.legacy.tsx ───────────────────────────── */
 ...
 * rawToBuilderTask
 * ─────────────────
 * Converts a raw Task API response into the shape AdminTaskBuilder.legacy uses.
